 ...
 *
 * This is the minimal wrapper used by the LYTE moderation reproducer. It
 * intentionally does not massage the request body — we want the raw payload
 * to match what downstream apps (e.g. LYTE) are sending so the behavior we
 ...
 * LYTE bug report. If the assistant *refuses* a benign homestead/tax question
